    ...
    <div className={classes.body}>
      <div className={classes.header}>
        <div>
          ...
          <p className={classes.intro}>Introduce Your Product Quickly & Effectively</p>
          <p className={classes.text}>
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
            <br/>
            <br /> Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.
          </p>
          ...
          <div className={classes.menudiv}>
            <button className={classes.menu} onClick={toggleDrawer}>☰ MENU</button>
            {isDrawerOpen && (
